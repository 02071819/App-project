                        ...
                        <View>
                            <View style={{ paddingVertical: 20 }}>
                                <TouchableOpacity onPress={goTo101}>
                                    <Image source={require('../../assets/101.jpg')} style={{
                                        width: 150,
                        ...
                        <View>
                            <View style={{ paddingVertical: 20 }}>
                                <TouchableOpacity onPress={goToCerem1}>
                                    <Image source={require('../../assets/hall.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20 }}>
                                <TouchableOpacity onPress={goToCerem2}>
                                    <Image source={require('../../assets/hall12.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20 }}>
                                <TouchableOpacity onPress={goToWest}>
                                    <Image source={require('../../assets/ww.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20 }}>
                                <TouchableOpacity onPress={goToMus}>
                                    <Image source={require('../../assets/museum.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 60 }}>
                                <TouchableOpacity onPress={goToPark}>
                                    <Image source={require('../../assets/p1.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 60 }}>
                                <TouchableOpacity onPress={goToTaiwanMus}>
                                    <Image source={require('../../assets/M2.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 60 }}>
                                <TouchableOpacity onPress={goToRedBuild}>
                                    <Image source={require('../../assets/red1.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 60 }}>
                                <TouchableOpacity onPress={goToPark2}>
                                    <Image source={require('../../assets/pp.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 60 }}>
                                <TouchableOpacity onPress={goToEgg}>
                                    <Image source={require('../../assets/EGG1.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 45 }}>
                                <TouchableOpacity onPress={goToNM1}>
                                    <Image source={require('../../assets/NM.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 45 }}>
                                <TouchableOpacity onPress={goToNM2}>
                                    <Image source={require('../../assets/NM1.png')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 45 }}>
                                <TouchableOpacity onPress={goToNM3}>
                                    <Image source={require('../../assets/NM3.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 45 }}>
                                <TouchableOpacity onPress={goToNM4}>
                                    <Image source={require('../../assets/NM5.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
                        ...
                        <View>
                            <View style={{ paddingVertical: 20, paddingTop: 45 }}>
                                <TouchableOpacity onPress={goToNM5}>
                                    <Image source={require('../../assets/NM2.jpg')} style={{
                                        width: 150,
                                        marginRight: 14, height: 250, borderRadius: 10
                                    }} />
